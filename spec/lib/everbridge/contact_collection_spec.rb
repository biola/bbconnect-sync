...
describe Everbridge::ContactCollection do
  let(:contact) { new_contact }
  let(:other_contact) { Everbridge::Contact.new(7654321, 'Jane', 'Doe', 'jane.doe@example.com', '3213214321') }
  ...
  describe '#-' do
    let(:other_collection) { Everbridge::ContactCollection.new }
  ...
  describe '.all' do
    ...
    let(:collection) { Everbridge::ContactCollection.all }
