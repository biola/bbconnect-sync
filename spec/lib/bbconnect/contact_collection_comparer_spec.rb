...
describe BBConnect::ContactCollectionComparer do
  ...
  let(:old_collection)      { BBConnect::ContactCollection.new }
  let(:new_collection)      { BBConnect::ContactCollection.new }
  let(:comparer)            { BBConnect::ContactCollectionComparer.new(old_collection, new_collection) }
